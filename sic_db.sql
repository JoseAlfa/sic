...
-- Volcando datos para la tabla sic_db.clientes: ~0 rows (aproximadamente)
DELETE FROM `clientes`;
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
/*!40000 ALTER TABLE `clientes` ENABLE KEYS */;

-- Volcando estructura para tabla sic_db.cotizaciones
...
-- Volcando datos para la tabla sic_db.cotizaciones: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sic_db.marcas: ~22 rows (aproximadamente)
DELETE FROM `marcas`;
/*!40000 ALTER TABLE `marcas` DISABLE KEYS */;
INSERT INTO `marcas` (`id_marca`, `nombre`, `clave`, `detalles`, `imagen`) VALUES
	(1, 'Phills', '09888ERR', 'ferreteria', NULL),
	(2, 'dd', 'd', 'd', 'd'),
	(3, 'dd', 'd', 'd', 'd'),
	(4, 'dd', 'd', 'd', 'd'),
	(5, 'dd', 'd', 'd', 'd'),
...
-- Volcando datos para la tabla sic_db.personas: ~0 rows (aproximadamente)
DELETE FROM `personas`;
/*!40000 ALTER TABLE `personas` DISABLE KEYS */;
INSERT INTO `personas` (`id_persona`, `nombre`, `apellidos`, `correo`, `telefono`) VALUES
	(1, 'Rigoberto', 'Nava Diaz', 'rigo@gmail.com', '9931230022');
/*!40000 ALTER TABLE `personas` ENABLE KEYS */;

-- Volcando estructura para tabla sic_db.presupesto_producto
CREATE TABLE IF NOT EXISTS `presupesto_producto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_producto` int(11) DEFAULT NULL,
  `id_cotizacion` int(11) DEFAULT NULL,
  `precio` varchar(70) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_presupesto_producto_productos` (`id_producto`),
  KEY `FK_presupesto_producto_cotizaciones` (`id_cotizacion`),
  CONSTRAINT `FK_presupesto_producto_cotizaciones` FOREIGN KEY (`id_cotizacion`) REFERENCES `cotizaciones` (`id_cotizacion`),
  CONSTRAINT `FK_presupesto_producto_productos` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla sic_db.presupesto_producto: ~0 rows (aproximadamente)
DELETE FROM `presupesto_producto`;
/*!40000 ALTER TABLE `presupesto_producto` DISABLE KEYS */;
/*!40000 ALTER TABLE `presupesto_producto` ENABLE KEYS */;

-- Volcando estructura para tabla sic_db.presupuestos_save
CREATE TABLE IF NOT EXISTS `presupuestos_save` (
...
-- Volcando datos para la tabla sic_db.presupuestos_save: ~0 rows (aproximadamente)
DELETE FROM `presupuestos_save`;
/*!40000 ALTER TABLE `presupuestos_save` DISABLE KEYS */;
/*!40000 ALTER TABLE `presupuestos_save` ENABLE KEYS */;

-- Volcando estructura para tabla sic_db.pre_save_productos
CREATE TABLE IF NOT EXISTS `pre_save_productos` (
  ...
  CONSTRAINT `FK_pre_save_productos_presupuestos_save` FOREIGN KEY (`id_pre_save`) REFERENCES `presupuestos_save` (`id_pre_save`),
...
-- Volcando datos para la tabla sic_db.pre_save_productos: ~0 rows (aproximadamente)
DELETE FROM `pre_save_productos`;
/*!40000 ALTER TABLE `pre_save_productos` DISABLE KEYS */;
/*!40000 ALTER TABLE `pre_save_productos` ENABLE KEYS */;
...
-- Volcando datos para la tabla sic_db.productos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sic_db.usuarios: ~1 rows (aproximadamente)
DELETE FROM `usuarios`;
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id_usuario`, `id_persona`, `nombre`, `contrasena`, `color`) VALUES
	(1, 1, 'rigo', '202cb962ac59075b964b07152d234b70', 'blue');
